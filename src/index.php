...
<head>
  ...
  <meta charset="UTF-8"> 
  <title><?=$title?></title>
  <link rel="stylesheet" href="@@remotepack/vendors.css?v=@@version">
  <link rel="stylesheet" href="@@remotepack/styles.css?v=@@version">
...
<body ng-controller="C_root as ctr" data-state="{{state}}" ng-class="{'skipIntro':ctr.hidePlayers}">
  ...
  <script type="text/javascript" src="@@remotepack/vendor.js?v=@@version"></script>
  <script type="text/javascript" src="@@remotepack/templates.js?v=@@version"></script>
  <script type="text/javascript" src="@@remotepack/scripts.js?v=@@version"></script>
</body>
</html>
